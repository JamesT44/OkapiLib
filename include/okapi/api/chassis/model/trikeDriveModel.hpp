...
namespace okapi {
class TrikeDriveModel : public ChassisModel {
  public:
  /**
   * Model for a trike drive (3 sets of wheels parallel with robot's direction of motion). 
   ...
   * @param imiddleSideMotor middle side motor
   * @param irightSideMotor right side motor
   */
  TrikeDriveModel(const std::shared_ptr<AbstractMotor> &ileftSideMotor,
  ...
  /**
   * Returns the middle side motor.
   *
   * @return the middle side motor
   */
  std::shared_ptr<AbstractMotor> getMiddleSideMotor() const;

  /**
   * Returns the right side motor.
   *
   * @return the right side motor
   */
  std::shared_ptr<AbstractMotor> getRightSideMotor() const;

  protected:
  std::shared_ptr<AbstractMotor> leftSideMotor;
  std::shared_ptr<AbstractMotor> middleSideMotor;
